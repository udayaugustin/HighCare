...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-b from-black/50 to-transparent backdrop-blur-sm">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex lg:items-center lg:space-x-8">
            ...
            <Link to="/clinics" className="text-white hover:text-gray-200 font-medium">Clinics</Link>
            <Link to="/doctors" className="text-white hover:text-gray-200 font-medium">Doctors</Link>
